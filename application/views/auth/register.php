        ...
        <div class="w-full md:w-1/2 p-8">
          ...
          <div class="flex justify-center mb-6">
            ...
            <a href="<?= site_url('login') ?>"
               class="px-6 py-2 bg-white text-teal-600 font-medium rounded-l-lg border border-teal-200 hover:bg-teal-50">
              Login
            </a>
            <!-- Tab Register (active) -->
            <a href="<?= site_url('register') ?>"
               class="px-6 py-2 bg-gradient-to-r from-teal-400 to-green-400 text-white font-medium rounded-r-lg border border-transparent">
              Register
            </a>
          </div>
          ...
          <?= form_open('register/submit', ['id' => 'registerForm']) ?>
            ...
            <div class="mb-4">
              ...
              <input
                ...
                required
              >
              <?= form_error('username','<small class="text-red-600">','</small>') ?>
            </div>
            ...
            <div class="mb-4 relative">
              ...
              <input
                ...
                required
              >
              <?= form_error('password_confirm','<small class="text-red-600">','</small>') ?>
              <!-- Ikon mata -->
              <div class="absolute inset-y-1.5 right-3 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg"
                     class="h-5 w-5 text-gray-400 cursor-pointer"
            ...
            <!-- Tombol Register (disabled sampai checkbox dicentang) -->
            <button
              type="submit"
              id="registerButton"
              disabled
